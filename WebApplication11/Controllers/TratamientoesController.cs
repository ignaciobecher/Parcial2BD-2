...
namespace WebApplication11.Controllers
{
    ...
    public class TratamientoesController : Controller
    {
        ...
        public TratamientoesController(WebApplication11Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,descripcion,medico,paciente,duracion")] Tratamiento tratamiento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,descripcion,medico,paciente,duracion")] Tratamiento tratamiento)
        {
